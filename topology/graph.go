// Package topology implements a generic, stable topological sorter.
//
...
// reused for unrelated orderings inside xbc -- plugin dependency
// resolution in core and middleware placement in protocol modules; graceful
// shutdown reverses the dependency order produced by core. Those callers do
// not agree on what a "node" even is (a plugin instance id, a qualified
