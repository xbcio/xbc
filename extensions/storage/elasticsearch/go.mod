module github.com/xbcio/xbc/extensions/storage/elasticsearch
...
// resolve XBC imports through go.work; this publishable manifest intentionally
// has no filesystem replace or placeholder version.
