...
func stopBounded(deadline context.Context, budget time.Duration, inst *container.Instance, closer plugin.Closer) error {
...
// out of a success.
func wrapStopError(inst *container.Instance, err error) error {
	if err == nil {
		return nil
	}
